...
docker-compose exec influxdb influx -execute "INSERT INTO grafana_rp config rp=\"autogen\",gb=\"1m\" 3600000000000"
docker-compose exec influxdb influx -execute "INSERT INTO grafana_rp config rp=\"1m\",gb=\"1m\" 86400000000000"
docker-compose exec influxdb influx -execute "INSERT INTO grafana_rp config rp=\"1h\",gb=\"1h\" 9223372036854775806" #-- max ns value in a 64-bit int